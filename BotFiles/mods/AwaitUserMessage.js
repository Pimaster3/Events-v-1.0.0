...
module.exports = {
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted">NAME of the node to jump if the user has sent the message. Note: IF the node to jump is after a double output node it won't jump</small>
    </div>
    <div class="form-group">
        <label>IF false jump to node called:</label>
        <input class="form-control" name="false"></input>
        <small class="form-text text-muted">NAME of the node to jump if the user hasn't sent the message. Note: IF the node to jump is after a double output node it won't jump</small>
    </div>
    <hr>
    <div class="form-group">
